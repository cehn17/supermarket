package com.cehn17.supermarket.controller;

import com.cehn17.supermarket.dto.SucursalDTO;
import com.cehn17.supermarket.service.ISucursalService;
...
public class SucursalController {
    ...
    public ResponseEntity<SucursalDTO> create(@RequestBody SucursalDTO dto) {
        ...
        return ResponseEntity.created(URI.create("/api/v1/sucursales/" + created.getId()))
                .body(created);
    }
